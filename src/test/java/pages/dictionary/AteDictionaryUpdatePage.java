...
public class AteDictionaryUpdatePage extends BasePage {
    ...
    //****************************************************************************************************************************************************************************
    public static String updateDateTime; //дата и время редактирования АТЕ
    ...
    public AteDictionaryPage updateATE(String title, AteDictionary ateDictionary) {
        log.debug("Тест " + context.getAttribute("testName") + ": проверить, содержит ли открывшееся диалоговое окно редактирования АТЕ заголовок '" + title + "'");
