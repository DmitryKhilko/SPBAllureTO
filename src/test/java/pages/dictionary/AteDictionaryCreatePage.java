...
public class AteDictionaryCreatePage extends BasePage {
    ...
    //****************************************************************************************************************************************************************************
    public static String createDateTime; //дата и время создания нового АТЕ
    ...
    public AteDictionaryPage createNewATE(String title, AteDictionary ateDictionary) {
        log.debug("Тест " + context.getAttribute("testName") + ": проверить, содержит ли открывшееся диалоговое окно добавления нового АТЕ заголовок '" + title + "'");
