...
//****************************************************************************************************************************************************************************
//План тестирования:
//Тесты сделаны зависимыми, для ускорения прохождения. Зависимсоть такая: если упадет
...
@Log4j2
public class AteDictionaryTest extends BaseTest {
    ...
    public void updateATE_UI(ITestContext context) throws InterruptedException, IOException {
        ...
        AteDictionary ate = AteDictionaryFactory.get("Брестская обл.", "г. Тестовый", "Тестовый РИК");
