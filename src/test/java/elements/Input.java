...
public class Input {
    ...
    //*****************************************************************************************************************************************************************************
    String inputLocator = "//label[@title='%s']/ancestor::div[contains(@class, 'ant-row ant-form-item')]//input[contains(@class, 'ant-input1')]"; //локатор поля ввода. На страницах и в панели фильтра они одинаковы
